...
export default function SignIn() {
    ...
    <section>
      ...
      <div className='md:w-[67%] lg:w-[50%]'>
        <img className=" img w-full rounded-2xl"src="https://plus.unsplash.com/premium_photo-1679860703713-9c9f5428f652?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGtleXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="Key" />
      </div>
